...
# Here y_study is m points in the parameter space, 
# which serves as the center of each mixed gaussian distribution
# std_dev is the std dev of each dimension in the parameter space
# freq is an array of size m, 
# where freq[i] represents how many points will be sample around y_study[i]
