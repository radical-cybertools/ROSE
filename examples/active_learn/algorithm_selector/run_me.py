...
async def select_algorithm():
    ...
    also = AlgorithmSelector(asyncflow)

    code_path = f"{sys.executable} {os.getcwd()}"

    # Define and register the simulation task
    @also.simulation_task
