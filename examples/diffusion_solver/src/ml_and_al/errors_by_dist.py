...
for i in range(1000, 17000, 1000):
    ...
    for j in range(10):
        ...
        jfile = json.load(open("/home/pb8294/Projects/DeepDiffusionSolver/diffusion-ai-results/log-transform/TwoSourcesRdm/simplecnn/2023-09-16-08-00-58/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-09-16_MSE-{}.json".format(i, j),))
        temp_random.append(jfile["100DGX-2023-09-16"]["mean"]["all"][0])
        
        jfile = json.load(open("/home/pb8294/Projects/DeepDiffusionSolver/diffusion-ai-results/log-transform/TwoSourcesRdm/simplecnn/2023-08-29-11-01-14/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-09-16_MSE-{}.json".format(i, j),))
        temp_loss.append(jfile["100DGX-2023-09-16"]["mean"]["all"][0])

        jfile = json.load(open("/home/pb8294/Projects/DeepDiffusionSolver/diffusion-ai-results/log-transform/TwoSourcesRdm/simplecnn/2023-08-27-17-03-24/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-09-16_MSE-{}.json".format(i, j),))
        temp_p6.append(jfile["100DGX-2023-09-16"]["mean"]["all"][0])

        jfile = json.load(open("/home/pb8294/Projects/DeepDiffusionSolver/diffusion-ai-results/log-transform/TwoSourcesRdm/simplecnn/2023-09-16-15-29-33/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-09-17_MSE-{}.json".format(i, j),))
        temp_p7.append(jfile["100DGX-2023-09-17"]["mean"]["all"][0])
        
        # jfile = json.load(open("/home/pb8294/Projects/DeepDiffusionSolver/diffusion-ai-results/log-transform/TwoSourcesRdm/simplecnn/2023-08-27-17-02-59/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-09-16_MSE-{}.json".format(i, j),))
...
df.to_csv("./MSE_error_nodrop_all_bydist_lponly.csv", index=False)
exit(0)

to_save = np.zeros((12, 10))
to_save[0::4,:] = to_save_random
to_save[1::4,:] = to_save_loss
to_save[2::4,:] = to_save_combine_std
to_save[3::4,:] = errors_combine_all

# to_save = np.vstack((to_save_random, to_save_loss, to_save_combine_std))
df = pd.DataFrame(to_save)
df.to_csv("./MAE_error_nodrop_all_bydist_lp.csv", index=False)
print(to_save.shape)
