...
for param in ["all", "src", "field", "ring1", "ring2", "ring3"]:
    ...
    for i in range(1000, 17000, 1000):
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/simplecnn/2023-11-16-10-24-43/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-11-20.json".format(i),))
    ...
    # paths = ["./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-03-09-14-44/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-01-10-13-01/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-01-10-10-53/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-01-10-08-13/"]
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/simplecnn/2023-11-16-10-24-43/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-11-20_MSE.json".format(i),))
        errors_std.append(jfile["100DGX-2023-11-20"]["mean"][param][0])
    ...
    for i in range(1000, 17000, 1000):
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/simplecnn/2023-11-16-10-24-43/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-11-20_loss.json".format(i),))
        errors_std.append(jfile["100DGX-2023-11-20"]["mean"][param][0])
