...
if __name__ == '__main__':
    ...
    # RANDOM
    paths = ["/home/pb8294/Projects/DeepDiffusionSolver/diffusion-ai-results/log-transform/TwoSourcesRdm/2023-08-23-09-21-30/"]

    # LOSS + P DIVERSITY
    # paths = ["./diffusion-ai-results/log-transform/TwoSourcesRdm/simplecnn/2023-09-16-15-29-33/"]

    # RANDOM, LOSS, PDIVERSITY, LOSS + PDIVRSITY
    ...
    paths = ["./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-09-29-06-54-16/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-09-28-11-52-57/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-09-21-10-51-02/"]
    ...
    for pt in paths:
        for alvsall in range(1000, 17000, 1000):
            ...
            os.path.isdir(PATH + "/AfterPlots/errors/uniform/") or os.mkdir(PATH + "/AfterPlots/errors/uniform/")
        ...
        #     selectedDirs[selectedDir] = t.errorPerDataset(PATH, theModel, device, BATCH_SIZE=BATCH_SIZE, NUM_WORKERS=NUM_WORKERS, std_tr=0.0, s=100)
            ...
            saveJSON(selectedDirs, os.path.join(PATH, "AfterPlots", "errors", "uniform"), f'errorsPerDS-{modelName}_MSEs.json')
        ...
        #		print(dict, '\n')
            ...
            print("done 2")
            modelName = next(iter(selectedDirs.keys()))
            saveJSON(selectedDirs, os.path.join(PATH, "AfterPlots", "errors", "uniform"), f'errorsPerDS-{modelName}s.json')
            myLog.logging.info(f'JSON object saved')
        ...
        #		print(dict, '\n')
            ...
            print("done 3")
            modelName = next(iter(selectedDirs.keys()))
            saveJSON(selectedDirs, os.path.join(PATH, "AfterPlots", "errors", "uniform"), f'errorsPerDS-{modelName}_losss.json')
            myLog.logging.info(f'JSON object saved')
