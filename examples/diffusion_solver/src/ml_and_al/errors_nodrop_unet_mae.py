...
for param in ["all", "src", "field", "ring1", "ring2", "ring3"]:
    ...
    for i in range(1000, 17000, 1000):
        ...
        errors_diverse.append(jfile["100DGX-2023-10-05"]["mean"][param][0])
        ...
        errors_lp.append(jfile["100DGX-2023-10-27"]["mean"][param][0])
        
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/entropy/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-12-01.json".format(i),))
        errors_std.append(jfile["100DGX-2023-12-01"]["mean"][param][0])
    ...
    df.to_csv("./tests_results/unet/final/mae/MAE_error_nodrop_{}_lp.csv".format(param), index=False)
    ...
    # paths = ["./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-03-09-14-44/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-01-10-13-01/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-01-10-10-53/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-01-10-08-13/"]
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-09-29-06-54-16/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-10-05_MSE.json".format(i),))
        errors_random.append(jfile["100DGX-2023-10-05"]["mean"][param][0])
        
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-09-28-11-52-57/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-10-05_MSE.json".format(i),))
        errors_loss.append(jfile["100DGX-2023-10-05"]["mean"][param][0])

        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-09-21-10-51-02/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-10-05_MSE.json".format(i),))
        errors_diverse.append(jfile["100DGX-2023-10-05"]["mean"][param][0])
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/entropy/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-12-01_MSE.json".format(i),))
        errors_std.append(jfile["100DGX-2023-12-01"]["mean"][param][0])
    ...
    df = pd.DataFrame(all_print)
    df.to_csv("./tests_results/unet/final/mae/MSE_error_nodrop_{}_lp.csv".format(param), index=False)
    ...
    # UNET
    for i in range(1000, 17000, 1000):
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-09-29-06-54-16/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-10-05_loss.json".format(i),))
        errors_random.append(jfile["100DGX-2023-10-05"]["mean"][param][0])
        
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-09-28-11-52-57/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-10-05_loss.json".format(i),))
        errors_loss.append(jfile["100DGX-2023-10-05"]["mean"][param][0])

        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-09-21-10-51-02/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-10-05_loss.json".format(i),))
        errors_diverse.append(jfile["100DGX-2023-10-05"]["mean"][param][0])
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/entropy/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-12-01_loss.json".format(i),))
        errors_std.append(jfile["100DGX-2023-12-01"]["mean"][param][0])
    ...
    df = pd.DataFrame(all_print)
    df.to_csv("./tests_results/unet/final/mae/loss_error_nodrop_{}_lp.csv".format(param), index=False)
