...
for param in ["all", "src", "field", "ring1", "ring2", "ring3"]:
    ...
    for i in range(1000, 17000, 1000):
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-09-09-53-45/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-11-27.json".format(i),))
        errors_diverse.append(jfile["100DGX-2023-11-27"]["mean"][param][0])
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-21-10-05-44/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-11-27.json".format(i),))
        errors_std.append(jfile["100DGX-2023-11-27"]["mean"][param][0])
    ...
    df.to_csv("./tests_results/unet/final/mse_loss/MAE_error_nodrop_{}_lp.csv".format(param), index=False)
    ...
    # paths = ["./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-03-09-14-44/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-09-09-53-45/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-01-10-10-53/", "./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-01-10-08-13/"]
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-09-09-53-45/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-11-27_MSE.json".format(i),))
        errors_diverse.append(jfile["100DGX-2023-11-27"]["mean"][param][0])
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-21-10-05-44/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-11-27_MSE.json".format(i),))
        errors_std.append(jfile["100DGX-2023-11-27"]["mean"][param][0])
    ...
    df = pd.DataFrame(all_print)
    df.to_csv("./tests_results/unet/final/mse_loss/MSE_error_nodrop_{}_lp.csv".format(param), index=False)
    ...
    for i in range(1000, 17000, 1000):
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-09-09-53-45/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-11-27_loss.json".format(i),))
        errors_diverse.append(jfile["100DGX-2023-11-27"]["mean"][param][0])
        ...
        jfile = json.load(open("./diffusion-ai-results/log-transform/TwoSourcesRdm/unetab/2023-11-21-10-05-44/{}/AfterPlots/errors/errorsPerDS-100DGX-2023-11-27_loss.json".format(i),))
        errors_std.append(jfile["100DGX-2023-11-27"]["mean"][param][0])
    ...
    df = pd.DataFrame(all_print)
    df.to_csv("./tests_results/unet/final/mse_loss/loss_error_nodrop_{}_lp.csv".format(param), index=False)
