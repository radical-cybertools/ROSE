...
def main():
    ...
    np.save(f"sample_cubic_rank_{rank}.npy", sample_cubic)
    np.save(f"sample_trigonal_rank_{rank}.npy", sample_trigonal)
    np.save(f"sample_tetragonal_rank_{rank}.npy", sample_tetragonal)
