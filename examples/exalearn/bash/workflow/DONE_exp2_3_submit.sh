...
################################  Start real job  ##############################
{
    ...
    (
        ...
        mpiexec -n 1 --ppn 1 --cpu-bind list:2,3,4,5,6,7,10,11,12,13,14,15,18,19,20,21,22,23,26,27,28,29,30,31 --env OMP_NUM_THREADS=24 --env OMP_PLACES=threads python ${exe_dir}/merge_preprocess_hdf5.py ${data_dir}/study/data cubic ${nthread_study}
        mpiexec -n 1 --ppn 1 --cpu-bind list:2,3,4,5,6,7,10,11,12,13,14,15,18,19,20,21,22,23,26,27,28,29,30,31 --env OMP_NUM_THREADS=24 --env OMP_PLACES=threads python ${exe_dir}/merge_preprocess_hdf5.py ${data_dir}/study/data trigonal ${nthread_study}
        mpiexec -n 1 --ppn 1 --cpu-bind list:2,3,4,5,6,7,10,11,12,13,14,15,18,19,20,21,22,23,26,27,28,29,30,31 --env OMP_NUM_THREADS=24 --env OMP_PLACES=threads python ${exe_dir}/merge_preprocess_hdf5.py ${data_dir}/study/data tetragonal ${nthread_study}
    ...
    (
        ...
        start2=$(date +%s%3N)
        mpiexec -n ${nthread_partial} --ppn ${nthread_partial} \
        ...
        mpiexec -n 1 --ppn 1 --cpu-bind list:2,3,4,5,6,7,10,11,12,13,14,15,18,19,20,21,22,23,26,27,28,29,30,31 --env OMP_NUM_THREADS=24 --env OMP_PLACES=threads python ${exe_dir}/merge_preprocess_hdf5.py ${data_dir}/stream_phase_1/data cubic ${nthread_partial}
        mpiexec -n 1 --ppn 1 --cpu-bind list:2,3,4,5,6,7,10,11,12,13,14,15,18,19,20,21,22,23,26,27,28,29,30,31 --env OMP_NUM_THREADS=24 --env OMP_PLACES=threads python ${exe_dir}/merge_preprocess_hdf5.py ${data_dir}/stream_phase_1/data trigonal ${nthread_partial}
        mpiexec -n 1 --ppn 1 --cpu-bind list:2,3,4,5,6,7,10,11,12,13,14,15,18,19,20,21,22,23,26,27,28,29,30,31 --env OMP_NUM_THREADS=24 --env OMP_PLACES=threads python ${exe_dir}/merge_preprocess_hdf5.py ${data_dir}/stream_phase_1/data tetragonal ${nthread_partial}
    ...
    (
        ...
        mpiexec -n 1 --ppn 1 --cpu-bind list:2,3,4,5,6,7,10,11,12,13,14,15,18,19,20,21,22,23,26,27,28,29,30,31 --env OMP_NUM_THREADS=24 --env OMP_PLACES=threads python ${exe_dir}/merge_preprocess_hdf5.py ${data_dir}/stream_phase_2/data cubic ${nthread_partial}
        mpiexec -n 1 --ppn 1 --cpu-bind list:2,3,4,5,6,7,10,11,12,13,14,15,18,19,20,21,22,23,26,27,28,29,30,31 --env OMP_NUM_THREADS=24 --env OMP_PLACES=threads python ${exe_dir}/merge_preprocess_hdf5.py ${data_dir}/stream_phase_2/data trigonal ${nthread_partial}
        mpiexec -n 1 --ppn 1 --cpu-bind list:2,3,4,5,6,7,10,11,12,13,14,15,18,19,20,21,22,23,26,27,28,29,30,31 --env OMP_NUM_THREADS=24 --env OMP_PLACES=threads python ${exe_dir}/merge_preprocess_hdf5.py ${data_dir}/stream_phase_2/data tetragonal ${nthread_partial}
