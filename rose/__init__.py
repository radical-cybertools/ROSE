...
_sys.modules['rose.rl.reinforcement_learner'] = _sys.modules['rose.reinforcement_learning.reinforcement_learner']
_sys.modules['rose.uq.uq_active_learner']     = _sys.modules['rose.uncertainty_quantification.uq_active_learner']
